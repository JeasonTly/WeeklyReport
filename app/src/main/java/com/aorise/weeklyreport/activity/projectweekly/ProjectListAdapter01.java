...
import com.aorise.weeklyreport.adapter.BaseViewHolder;
 ...
 * Date: 2019/6/28.
 */
public class ProjectListAdapter01 extends BaseAdapter<ProjectList, BaseViewHolder> implements Filterable {
    ...
    public ProjectListAdapter01(Context context, List<ProjectList> projectBaseInfos) {
        super(context);
    ...
    public BaseViewHolder onCreateVH(ViewGroup parent, int viewType) {
        ItemListProjectBinding mViewDataBinding = DataBindingUtil.inflate(inflater, R.layout.item_list_project_01, parent, false);
